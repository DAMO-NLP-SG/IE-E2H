...
class DataTrainingArguments:
    ...
    stage: str = field(
        default="main",
        metadata={
            "help": "easy, hard, or main."
        },
    )
    skills: str = field(
        default="",
        metadata={
            "help": "Skills for the easy stage."
        },
    )
    sent_num: int = field(
        default=2,   # for the hard stage
        metadata={
            "help": "The number of sentences for concatenation."
        },
    )
    M: int = field(
        default=1,   # for the hard stage
        metadata={
            "help": "How many examples for each training example of the main task"
        },
    )
    empty_ratio: float = field(
        default=1,  # for the easy stage
        metadata={
            "help": "For downsampling the empty data. Empty data is at most a ratio of the whole data. Set 1 if there is no downsampling."
        },
    )
